...
const createTaskEditColorsTemplate = (curentColor) => {
...
export const createTaskEditTemplate = (task = {}) => {
  ...
  const repeatigTemplate = createTaskEditRepeatingTemplate(repeating);
  const repeatingColors = createTaskEditColorsTemplate(color);
